const translations = {
  es: {
    ...
    hero_title: "Aaron Brumat <span>Full Stack</span>",
    ...
    about_text: "Soy estudiante del ultimo año de Desarrollo de Software en el Terciario Urquiza (Rosario). Tengo disponibilidad full time para contrataciones en empresa y tambien acepto proyectos freelance. Con foco en construir productos claros, eficientes y escalables.",
    ...
    services_text: "Como perfil Full Stack, me enfoco en ofrecer un servicio integral que cubre tanto el diseño como el desarrollo de productos digitales. Mi objetivo es crear soluciones completas y coherentes que funcionen perfectamente. Ademas tambien ofreceran una experiencia de usuario excepcional.",
    ...
    process_3_text: "Entrega con testing y ajustes segun feedback.",
    ...
    project_1_text: "Centraliza clientes, productos, ventas y stock en un solo sistema. Interfaz clara en Tkinter y reportes exportables.",
    ...
    project_1_stack_4: "Google Cloud",
    project_2_title: "Data Center",
    project_2_tag: "Calidad de datos",
    project_2_text:
      "Plataforma full stack para monitorear calidad de datos en ecommerce y logística, con dashboard operativo, corridas de calidad y gestión de incidencias.",
    project_2_feature_1: "Autenticación local + Google y control de acceso por roles.",
    project_2_feature_2: "Datasets con alta, carga CSV o generación demo y corridas de calidad.",
    project_2_feature_3: "Detección de issues/anomalías, casos con SLA, timeline, notas y workflow.",
    project_2_feature_4: "Recomendaciones accionables, reportes exportables y administración de usuarios.",
    project_2_stack_1: "Next.js",
    project_2_stack_2: "TypeScript",
    project_2_stack_3: "FastAPI",
    project_2_stack_4: "PostgreSQL",
    project_btn_app: "Visualizar app",
    ...
    project_2_shot_dashboard: "Dashboard general",
    project_2_shot_login: "Login",
    project_2_shot_datasets: "Datasets",
    project_2_shot_runs: "Historial de calidad",
    project_2_shot_cases: "Workflow de incidentes",
    project_2_shot_recommendations: "Recomendaciones",
    ...
    case_2_eyebrow: "Caso de estudio",
    case_2_title_main: "Data Center",
    case_2_intro:
      "Plataforma orientada a detectar problemas de calidad de datos, priorizar riesgo operativo y convertir hallazgos en acciones concretas.",
    case_2_problem_title: "Problema",
    case_2_problem_text:
      "Operaciones con datasets críticos sin una vista unificada de calidad, anomalías, impacto y responsables.",
    case_2_solution_title: "Solucion",
    case_2_solution_text:
      "App web full stack con Next.js + FastAPI para monitoreo, corridas de calidad, gestión de casos, recomendaciones y usuarios.",
    case_2_results_title: "Resultados",
    case_2_results_item_1: "Dashboard operativo con KPIs, riesgo, impacto y salud por dataset.",
    case_2_results_item_2: "Workflow de incidentes con SLA, timeline, notas y seguimiento.",
    case_2_results_item_3: "Recomendaciones accionables, exportes y administración por roles.",
    case_2_tag_1: "Proyecto full stack",
    case_2_tag_2: "Ecommerce + Logistica",
    ...
    edu_1_place: "Terciario Urquiza, Rosario | Ultimo año",
  ...
  en: {
    ...
    profile_summary: "Full Stack available full time and freelance.",
    ...
    services_text: "As a Full Stack profile, I focus on providing an end-to-end service covering both design and development of digital products. My goal is to create complete and coherent solutions that work seamlessly. Additionally, they will also offer an exceptional user experience.",
    ...
    process_3_text: "Delivery with testing and adjustments from feedback.",
    ...
    projects_text: "Selected projects that show product thinking, full-stack execution, and attention to detail.",
    project_1_title: "StockARG",
    ...
    project_2_title: "Data Center",
    project_2_tag: "Data quality",
    project_2_text:
      "Full-stack platform for monitoring data quality in ecommerce and logistics, with an operational dashboard, quality runs, and incident management.",
    project_2_feature_1: "Local + Google authentication with role-based access control.",
    project_2_feature_2: "Datasets with creation, CSV upload or demo generation, and quality runs.",
    project_2_feature_3: "Issue/anomaly detection plus SLA-driven cases, timeline, notes, and workflow.",
    project_2_feature_4: "Actionable recommendations, exportable reports, and user administration.",
    project_2_stack_1: "Next.js",
    project_2_stack_2: "TypeScript",
    project_2_stack_3: "FastAPI",
    project_2_stack_4: "PostgreSQL",
    project_btn_app: "View app",
    ...
    project_2_shot_dashboard: "Overview dashboard",
    project_2_shot_login: "Login",
    project_2_shot_datasets: "Datasets",
    project_2_shot_runs: "Quality history",
    project_2_shot_cases: "Incident workflow",
    project_2_shot_recommendations: "Recommendations",
    ...
    case_tag_2: "2 weeks",
    case_2_eyebrow: "Case study",
    case_2_title_main: "Data Center",
    case_2_intro:
      "Platform focused on detecting data quality issues, prioritizing operational risk, and turning findings into concrete actions.",
    case_2_problem_title: "Problem",
    case_2_problem_text:
      "Critical datasets managed without a unified view of quality, anomalies, impact, and ownership.",
    case_2_solution_title: "Solution",
    case_2_solution_text:
      "Full-stack web app built with Next.js + FastAPI for monitoring, quality runs, case management, recommendations, and users.",
    case_2_results_title: "Results",
    case_2_results_item_1: "Operational dashboard with KPIs, risk, impact, and dataset health.",
    case_2_results_item_2: "Incident workflow with SLA, timeline, notes, and follow-up.",
    case_2_results_item_3: "Actionable recommendations, exports, and role-based administration.",
    case_2_tag_1: "Full-stack project",
    case_2_tag_2: "Ecommerce + Logistics",
    ...
    edu_1_place: "Terciario Urquiza, Rosario | Final year",
