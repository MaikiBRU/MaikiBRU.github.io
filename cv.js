const translations = {
  es: {
    ...
    cv_skills_1: "Python, C#, JavaScript, TypeScript",
    cv_skills_2: "MySQL Workbench y SQL",
    cv_skills_3: "HTML y CSS",
    cv_skills_4: "UI/UX y diseño web",
    cv_skills_5: "Frameworks: Django, Flask, FastAPI",
    cv_skills_6: "Aprendiendo: Haskell",
    ...
    cv_education_school: "Terciario Urquiza, Rosario",
    cv_education_program: "Desarrollo de Software (en curso)",
    cv_education_secondary: "Secundaria completa - Maria Bicecci (2019 - 2023)",
    cv_certificate: "Certificado: Bases de programacion con IA - Big School (2026)",
    ...
    cv_project_1: "Login con email/contraseña y opción Google.",
    ...
    cv_project_meta_4: "Google Cloud",
  ...
  en: {
    ...
    cv_education_school: "Terciario Urquiza, Rosario",
    cv_education_program: "Software Development (in progress)",
    cv_education_secondary: "High school completed - Maria Bicecci (2019 - 2023)",
    cv_certificate: "Certificate: Programming basics with AI - Big School (2026)",
    ...
    cv_project_name: "StockARG",
    cv_project_desc:
      "Stock, sales, and customer management system with a modern Tkinter UI.",
